...
console.warn(`Modifica exemplul astfel incat bucla sa numere de la 1 la 31 (dar nu schimba numarul 32), afisand in consola propozitii de forma
...
var limitB = 15;
console.warn(`Folosind keywordul break, opreste bucla atunci cand numarul este egal cu 15 (dar afiseaza-l), afisand propozitii de forma “Ma voi opri la 15: i.”.
`);
for (var i = 1; i < limitA; i++) {
...
console.warn(`Folosind keywordul continue, afiseaza doar numerele pare intre 1 si 32 (inclusiv 32 ) cu propozitii de forma
